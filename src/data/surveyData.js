  ...
  block1: {
    ...
    questions: [
      ...
      },
      {
        id: 'q2',
        type: 'checkbox',
        title: '問２：貴社が実施している事業内容は何ですか、該当するもの全てを選択して下さい。',
        required: true,
        options: [
          '【特積】貨物自動車運送事業',
          '【特定】貨物自動車運送事業',
      ...
      },
      {
        id: 'q3',
        type: 'number',
        title: '問３：貴社が保有するトラック運送事業用自動車の台数をご入力ください。（非牽引車を含める）',
        required: true,
        unit: '台'
      },
      {
        id: 'q4',
        type: 'radio',
        title: '問４：貴社では、女性ドライバーを雇用していますか、該当するもの１つを選択して下さい。',
        required: true,
        options: [
      ...
      },
      {
        id: 'q5',
        type: 'radio',
        title: '問５：女性ドライバーの雇用の必要性や意義を感じますか。該当するもの１つを選択して下さい。',
        required: true,
        options: [
          'とても感じる',
          '少し感じる',
      ...
      },
      {
        id: 'q6',
        type: 'radio',
        title: '問６：女性ドライバーの雇用に関する今後の予定について、該当するもの１つを選択して下さい。',
        required: true,
        options: [
          '雇用を増加させたい',
          '条件が合えば雇用したい',
    ...
    questions: [
      {
        id: 'b2q1',
        type: 'grid',
        title: '問１：2020年及び2025年9月現在の貴社の男女別従業員数（パート、アルバイトを含む）と、その内訳（ドライバー・その他）のおおよその人数をご入力ください。',
        required: true,
        rows: [
      ...
      },
      {
        id: 'b2q2',
        type: 'select',
        title: '問２：女性ドライバーの平均在職年数について、おおよその数字をご入力ください。',
        required: true,
      ...
      },
      {
        id: 'b2q3',
        type: 'grid_select',
        title: '問３：以下の運行形態（長距離、近・中距離等）別に、従事している女性ドライバーの人数をご入力ください。',
        required: true,
      ...
      },
      {
        id: 'b2q4',
        type: 'grid_select',
        title: '問４：車両別に、女性ドライバーが乗務している人数をご入力回答ください。',
        required: true,
      ...
      },
      {
        id: 'b2q5',
        type: 'grid_select',
        title: '問５：以下の車両形状別に、女性ドライバーが乗務している人数をご入力回答ください。',
        required: true,
      ...
      },
      {
        id: 'b2q6',
        type: 'checkbox',
        title: '問６：女性ドライバーが取扱っている主な品目は何ですか。該当するもの全てを選択してください。',
        required: true,
        options: [
          '農水産品、林産品',
          '海上コンテナ',
      ...
      },
      {
        id: 'b2q7',
        type: 'checkbox',
        title: '問７：女性ドライバーの主な積込み・取卸しに関する荷役作業について、該当するもの全てを選択してください。',
        required: true,
        options: [
          '手積み・手卸しによる荷役作業',
      ...
      },
      {
        id: 'b2q8',
        type: 'checkbox',
        title: '問８：採用した女性ドライバーで「必要な免許は保有していなかった」場合の対応をお聞きします。免許取得あるいは免許区分の上位免許の更新に向についてどのようにしましたか。',
        required: true,
        options: [
          '会社が全額負担',
          '会社が費用の一部を負担',
      ...
      },
      {
        id: 'b2q9',
        type: 'checkbox',
        title: '問９：女性ドライバーは運転免許以外にどのような免許を取得していますか、該当するもの全てを選択してください。',
        required: true,
        options: [
          'フォークリフト',
          '危険物取扱',
    ...
    questions: [
      {
        id: 'b3q10',
        type: 'checkbox',
        title: '問１０：貴社の女性ドライバーの採用方法について、該当するもの全てを選択してください。',
        required: true,
        options: [
          'ハローワーク',
          'インターネット求人サイト',
      ...
      },
      {
        id: 'b3q11',
        type: 'checkbox',
        title: '問１１：女性ドライバーを採用するために、工夫していることはありますか。',
        required: true,
        options: [
      ...
      },
      {
        id: 'b3q12',
        type: 'textarea',
        title: '問１２：問２でお答えいただいた工夫について、特に有効と考えられる採用方法や工夫があれば、お差し支えない範囲で具体的にご入力ください。',
        required: false,
        maxLength: 500
      },
      {
        id: 'b3q13',
        type: 'checkbox',
        title: '問１３：女性ドライバーの雇用によるメリット（良い点）について、該当するもの全てを選択してください。',
        required: true,
        options: [
      ...
      },
      {
        id: 'b3q14',
        type: 'checkbox',
        title: '問１４：女性ドライバーを雇用することで、問題をお感じですか。該当するもの全てを選択してください。',
        required: true,
        options: [
      ...
      },
      {
        id: 'b3q15',
        type: 'textarea',
        title: '問１５：問２でご回答いただいた問題について、具体的にどのようなことがありますか。また、問題解決のために取組まれている対策について、具体的にご入力ください。',
        required: false,
        maxLength: 500
      },
      {
        id: 'b3q16',
        type: 'radio',
        title: '問１６：貴社では、女性ドライバーは定着している（または定着していた）と思いますか。該当するもの１つを選択してください。',
      ...
      },
      {
        id: 'b3q17',
        type: 'textarea',
        title: '問１７：女性ドライバーの退職理由にはどのようものがありますか。',
        required: false,
        maxLength: 500
      },
      {
        id: 'b3q18',
        type: 'checkbox',
        title: '問１８：女性ドライバーが定着するための取組事項として、該当するもの全てを選択してください。',
        required: true,
        options: [
          '女性管理職の起用',
      ...
      },
      {
        id: 'b3q19',
        type: 'textarea',
        title: '問１９：上記でご回答された社内の取組について、具体的にお教えください。',
        required: false,
        maxLength: 500
      },
      {
        id: 'b3q20',
        type: 'textarea',
        title: '問２０：女性ドライバーから、日頃どのような相談、要望がありますか。',
        required: false,
        maxLength: 500
      }
    ]
    ...
    questions: [
      {
        id: 'b4q1',
        type: 'checkbox',
        title: '問１：女性を採用するうえで、お悩みの事柄はありますか。該当するもの全てを選択してください。',
        required: true,
        options: [
      ...
      },
      {
        id: 'b4q2',
        type: 'checkbox',
        title: '問２：トラック運送業界における女性活躍を進めるために、経営者のお立場から望むことは何ですか。該当するもの全てを選択してください。',
        required: true,
        options: [
      ...
      },
      {
        id: 'b4q3',
        type: 'radio',
        title: '問３：女性活躍に対する助成金制度（厚生労働省「両立支援等助成金」等）について、該当するもの1つを選択してください。',
        required: true,
        options: [
          '制度を活用したことがある（活用している）',
          '制度は知っているが、活用したことがない',
      ...
      },
      {
        id: 'b4q4',
        type: 'textarea',
        title: '問４：女性活躍のために、助成金をどのように活用したいと思いますか。',
        required: false,
        maxLength: 500,
        rows: 4
      },
      {
        id: 'b4q5',
        type: 'radio',
        title: '問５：国土交通省では、女性ドライバーである「トラガール」増加への取組みを実施していますが、女性ドライバーの増加を実感できますか、該当するもの１つを選択してください。',
        required: true,
        options: [
          '増加を実感できる',
          '増加を実感できない',
      ...
      },
      {
        id: 'b4q6',
        type: 'textarea',
        title: '問６：女性ドライバーの採用や人材育成について、ご意見やご要望がありましたら、自由にご入力ください。',
        required: false,
        maxLength: 500,
        rows: 6
      }
